...
final class Ml8Platform implements Platform {
    ...
    public void addToClasspath(Path jar) {
        ...
        if (!(loader instanceof URLClassLoader)) {
            throw new NyliumException("Nylium's ModLauncher 8 service was not loaded by a "
        ...
        try {
            ...
            throw new NyliumException("Could not add " + jar + " to the ModLauncher 8 service class loader", e);
        }
    }
