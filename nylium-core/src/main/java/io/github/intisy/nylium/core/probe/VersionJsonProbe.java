 ...
 *
 * @implNote Matches the field with a regex rather than a JSON parser because {@code nylium-core}
...
public final class VersionJsonProbe implements VersionProbe {
     ...
     * match itself a regex, so {@code nylium-core} still needs no JSON dependency.
     */
